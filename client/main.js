...
function selectAllItems() {
	...
	xhttp.open("GET", "http://localhost:8080/jaxrs_jpa_hibernate/items");
...
function insertItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('POST', 'http://localhost:8080/jaxrs_jpa_hibernate/items');
...
function updateItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('PUT', 'http://localhost:8080/jaxrs_jpa_hibernate/items/' + id);
    xhttp.setRequestHeader('Content-Type', 'application/json');
    xhttp.onload = function() {
        selectAllItems();
    }
...
function deleteItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('DELETE', 'http://localhost:8080/jaxrs_jpa_hibernate/items/' + id);
    xhttp.onload = function() {
        selectAllItems();
    }
    xhttp.send();
